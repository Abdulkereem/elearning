var site_settings = '<div class="ts-button" style="display:none">'
        +'<span class="fa fa-cogs fa-spin"></span>'
    +'</div>'
    +'<div class="ts-body">'
	    +'<div class="ts-title">Themes</div>'
        +'<div class="ts-themes">'
            +'<a href="javascript.void(0)" class="active" data-theme="../static/css/theme-default.css"><img src="../static/img/themes/default.jpg"/></a>'            
            +'<a href="javascript.void(0)" data-theme="../static/css/theme-brown.css"><img src="../static/img/themes/brown.jpg"/></a>'
            +'<a href="javascript.void(0)" data-theme="../static/css/theme-blue.css"><img src="../static/img/themes/blue.jpg"/></a>'                        
            +'<a href="javascript.void(0)" data-theme="../static/css/theme-white.css"><img src="../static/img/themes/light.jpg"/></a>'            
            +'<a href="javascript.void(0)" data-theme="../static/css/theme-black.css"><img src="../static/img/themes/black.jpg"/></a>'
        +'</div>'
